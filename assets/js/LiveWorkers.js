...
//	as separate files
//
//	Normally called from LiveWorkers.html
//
...
function getLiveWorkers() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=2";
	...
	$.getJSON(url,function(data){
		...
		downloadDAT({ data: data, filename: "LiveWorkers.dat" });
...
function getLegislativeData() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=3";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonName() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=4";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getWorkRelationship() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=5";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getWorkTerms() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=6";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonPhone() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=7";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonEmail() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=8";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonAddress() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=9";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonAssignment() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=10";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonAssignmentWithPosition() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=13";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonEthnicity() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=12";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonDisability() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=14";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonReligion() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=15";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonNationalIdentifier() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=16";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonCitizenship() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=17";
	// var eventsfound = false;
	$.getJSON(url,function(data){
...
function getPersonDisabilityBlanks() {
	...
	var url = "http://its-n-jcnc-01/UoB/liveJSON.asp?id=50";
	// var eventsfound = false;
	$.getJSON(url,function(data){
